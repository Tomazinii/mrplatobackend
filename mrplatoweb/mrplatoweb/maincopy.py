...
class InputAdditionalForm(BoxLayout):
    ...
    def inputAditionalFormulaOrHyphotesis(self):
        ...
        if r0 and rl:
            ...
            self.ids.in_new_form.text = 'Add ADDITIONAL FORMULA'
            self.input_l = []
            return
        return
...
#####KIVY
    ...
    def getSelectedSubFormula2(self,  selection, original_form):
        ...
        if not (r0 and r):
            PopupMessage(' ERRON IN LINES!!!!!!!!', '#FF33FF')  # cor lilás
            return
