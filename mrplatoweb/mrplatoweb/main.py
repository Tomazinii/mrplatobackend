...
class InputArgumentBox():
    ...
    def inputPremiss(self,form):
        ...
        print("ESSE CARA ", self.input_premisses)
        print("ESSE CARA ", self.input_premisses)
        print("ESSE CARA ", self.input_premisses)
...
#####KIVY
    ...
    def get_just_one_selected_line(self,lines):
        if len(lines) == 1:
            ...
            print("SELECT JUST ONE PROOF LINE, PLEASE.")
            return False, 0
    ...
    def getSelectedSubFormula2(self,  selection, original_form):
        ...
        if not (r0 and r):
            raise Exception("ERRON IN LINES!!!!!!!!")

        try:
            rule_type, ruleNumber = self.selected_rule_index
        except:
            raise Exception('CHOOSE A RULE FIRST.')
    ...
    def delLastLine(self):
        ...
        if len(self.line_stack) == 0:
            raise Exception('YOU GOT BACK TO THE INITIAL POINT.')
        else:
    ...
    def appRule(self):
       ...
       #kivy print(f'self.selected_rule_index: {self.selected_rule_index}')
        ...
        if self.proof_lines == []:
            ...
            return'ENTER PREMISSES FIRST, PLEASE.'
    ...
    def app_Inf_Eq_Pred_rule(self,ruleType,ruleNumber):
        ...
        if self.selected_lines == []:
            ...
            # return 'CHOOSE A PROOF LINE FIRST, PLEASE.'
            raise Exception('CHOOSE A PROOF LINE FIRST, PLEASE.')
        else:
